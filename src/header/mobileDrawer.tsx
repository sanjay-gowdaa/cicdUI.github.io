        ...
        <div className="mobile-visible">
            ...
            >
                ...
                <Breadcrumb className="mobile-header-breadcrumb"  separator=" ">
                    ...
                    <Breadcrumb.Item href="#users" onClick={() => setVisible(false)}>
                        {t('landing_page.header.breadcrumb.users')}
                    </Breadcrumb.Item>
                    <Breadcrumb.Item href="#aboutUs" onClick={() => setVisible(false)}>
                        {t('landing_page.header.breadcrumb.about_us')}
                    </Breadcrumb.Item>
