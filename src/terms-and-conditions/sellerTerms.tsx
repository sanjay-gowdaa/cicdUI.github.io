    ...
    return (
        <div className="general-terms">
            ...
            <Paragraph>
                <ol className="upper-roman-list-style">
                    <Space direction="vertical">
                        <li>Account -- profile to be created by the Seller to have free access and use of the Platform</li>
                        <li>
                            Buyer(s) -- means purchaser or agent or wholesaler or retailer who wants to buy produce
                        ...
                        <li>Payment Service Provider -- <a href="https://www.cashfree.com/" target="_blank"><b>Cashfree</b></a>,
                        ...
                        <li>
                            Seller(s) -- means a farmer or agent or farmer self-help group or party who is in
            ...
            <Paragraph>
                <ol className="upper-roman-list-style">
                    <Space direction="vertical">
                        ...
                        <li>
                            In case of an individual being a Seller on the Platform, he/she shall provide a declaration to the effect
                            that he/she is an unregistered seller/dealer
                        </li>
                        <li>
                            KYC data of the Seller shall be validated by SamparkBindhu back office, within a period of upto 14 working day.
                            After this validation and approval, the Seller may use the Platform
                        </li>
                ...
                <ol className="lower-roman-list-style">
                    <Space direction="vertical">
                        ...
                        <li>
                            ...
                            shall go back to the pool and other potential buyer (old and new) will be matched with the Seller
                        </li>
                    </Space>
                </ol>
            </Paragraph>
            ...
            <Paragraph>
                <ol className="lower-roman-list-style">
                    <Space direction="vertical">
                        ...
                        <li>
                            The Seller acknowledge that when placing and accepting an order for a Product from the Buyer,
                            the Buyer and the Seller are entering into a legally binding  purchase agreement
                            (“<b>Purchase Agreement/Digital Contract</b>”). The Seller shall adhere to the terms of the Purchase
                        ...
                        <li>
                            ...
                            pool and other potential buyer or seller (old and new) will be matched
            ...
            <Paragraph>
                <ol className="upper-roman-list-style">
                    <li>
                        The Seller shall be responsible for transportation of the agriculture Products to the Buyer and may
                        be charged for the Services provided by the Service Provider ("<b>Transportation Fees</b>") for the same.
                        This amount shall be added to the price applicable for selling the agricultural products and for provision
                        of Services, the amount due to SamparkBindhu shall be deducted from the price indicated to the Seller
                        for this purpose
                    </li>
                    <li>
                        However, in the event, the Seller fails to provide for transportation of the agriculture Products to the Buyer,
                        the same shall be informed to SamparkBindhu by the Seller and accordingly SamparkBindhu shall make arrangement
                        for transportation of the Products to the Buyer and the Transportation Fees shall be borne by the Buyer
                    </li>
                    <li>
                        SamparkBindhu makes no guarantee or representation with respect to providing  transportation services between
                        the Seller and the Buyer. In the event, SamparkBindhu fails to make arrangement for the transportation of the
                        Products to Buyer, the same shall be intimated by SamparkBindhu to the Buyer, thereafter the Buyer shall be
                        responsible for make arrangement for transportation of the Products and make payment for the same
                    </li>
                </ol>
                <Paragraph>The process would traverse iteratively in a sequence. It would be manual and outside the scope of the platform</Paragraph>
            </Paragraph>
            ...
            <Paragraph>
                <ol className="lower-roman-list-style">
                    <Space direction="vertical">
                        <li>
                            If the Product at the time of delivery does not meet the approved sample,
                            the Buyer shall have the right to reject the complete lot subject to detailed
                            investigation by SamparkBindhu Field Officers. However, the Buyer shall not be
                            required to make remaining payment first to complete the delivery. On approval
                            from SamparkBindhu team, the Product, if rejected shall be sent back to the
                            Seller and the provision of Services expenses would be borne by the Seller. Amount
                            paid by the Buyer towards the purchase shall be refunded within 3 working days along
                            with 20% penalty amount to the Seller. SamparkBindhu would facilitate such transaction
                            for speedy recovery and resolution
                        </li>
                        <li>
                            SamparkBindhu does not take the responsibility of the QC check at the time of dispatch
                            or delivery. The platform  will attempt best case a very basic quality check SamarkBindhu
                            or its platform It  cannot be held responsible for any quality lapses reported by the Buyer.
                            It shall be the responsibility of the Seller and the Buyer to do so at the time of f dispatch
            ...
            <Paragraph>
                <ol className="lower-roman-list-style">
                    <Space direction="vertical">
                        ...
                        <li>
                            Platform also uses tools and applications to detect, censor and filter unlawful content.
                            In the event of detection of such content, Platform reserves the right to suspend users
                            accounts, services and terminate any agreements in force
                        </li>
                        <li>
