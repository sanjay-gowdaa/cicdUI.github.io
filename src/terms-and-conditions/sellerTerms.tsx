...
const SellerTerms = () => {
    return (
        <div className="general-terms">
            <Title level={5} style={{fontSize: "small"}}>Seller Terms</Title>
            ...
            <Title level={5} style={{fontSize: "small"}}>3. Conditions Of Use And Operation Of The Platform</Title>
            ...
            <Title level={5} style={{fontSize: "small"}}>4. Seller's Obligations</Title>
            <Paragraph>
                <ol className="lower-roman-list-style">
                    <Space direction="vertical">
                    <li>
            ...
            <Paragraph>
                <ol className="lower-roman-list-style">
                    ...
                    <li>
                        ...
                        on the website: [●]. Changes made to the Terms and Conditions shall not be retroactive and shall not 
            ...
            <Title level={5} style={{fontSize: "small"}}>13. </Title>
            <Space direction="vertical">
